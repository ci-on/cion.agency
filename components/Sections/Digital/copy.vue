<template>
  <div class="h-full md:py-8">
    <div
      ref="image"
      class="relative w-full bg-digital-image text-white p-10 md:p-20 h-full flex flex-col justify-center rippled-image"
    >
